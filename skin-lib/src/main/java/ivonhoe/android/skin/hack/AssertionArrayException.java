...
public class AssertionArrayException extends Exception {
    ...
    public static AssertionArrayException mergeException(AssertionArrayException assertionArrayException, AssertionArrayException assertionArrayException2) {
        ...
        AssertionArrayException assertionArrayException3 = new AssertionArrayException(assertionArrayException.getMessage() + Skin.SYMBOL_SEMICOLON + assertionArrayException2.getMessage());
    ...
    public String toString() {
        ...
        for (Hack.HackDeclaration.HackAssertionException hackAssertionException : this.mAssertionErr) {
            stringBuilder.append(hackAssertionException.toString()).append(Skin.SYMBOL_SEMICOLON);
            try {
                if (hackAssertionException.getCause() instanceof NoSuchFieldException) {
                    ...
                    stringBuilder.append(hackAssertionException.getHackedClass().getName()).append(".").append(hackAssertionException.getHackedFieldName()).append(Skin.SYMBOL_SEMICOLON);
                    ...
                    stringBuilder.append(hackAssertionException.getHackedClass().getName()).append("->").append(hackAssertionException.getHackedMethodName()).append(Skin.SYMBOL_SEMICOLON);
